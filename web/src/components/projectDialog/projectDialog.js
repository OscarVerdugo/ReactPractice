...
const ProjectDialog = (props) => {
  ...
  return (
    ...
    >
      <DialogTitle className={classes.dialogTitle}>{props.project.name}</DialogTitle>
          ...
          <div className={classes.dialogCollaboratorsList}>
            <TableContainer component={Paper} elevation={0}>
              <Table className={classes.table} size="small" stickyHeader>
                ...
                <TableBody>
                  {props.project.collaborators && props.project.collaborators.map(row => (
                    <TableRow key={row.id}>
...
export default connect(mapStateToProps,mapDispatchToPropst)(ProjectDialog);
